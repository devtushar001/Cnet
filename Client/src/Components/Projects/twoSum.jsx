  ...
  return (
    <div className="two-sum">
      <div className="input-details">
        ...
        <input
          type="text"
          placeholder="Array values (e.g., 7,8,5,4,11,5...)"
          onChange={(e) => {
            const values = e.target.value.split(',').map(Number); // Convert input to an array of numbers
            setNums(values);
          }}
        />
        ...
        <input
          type="number"
          placeholder="Your target (e.g., 15)"
